...
void tambahTugas() {
    string nama_matkul, deskripsi_tugas, deadline;
    int status;
    ...
    cout << "Masukkan deadline tugas (tanggal,bulan): ";
    cin >> deadline;
...
void lihatDaftarTugas() {
    ...
    for (int i = 0; i < 100; i++) {
        if (dataTugas[i].nama_matkul != "") {
            ...
            cout << "Deadline: " << dataTugas[i].deadline << endl;
            cout << "Status: ";
    ...
    while (true) {
        ...
        switch (menu) {
            ...
            case 4:
                ...
                break;
            case 5:
                cout << "Terima kasih telah menggunakan program joki tugas ini!" << endl;
                return 0;
            default:
